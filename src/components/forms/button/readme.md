...
| `padding`     | `padding`     | Sets the padding inside of the button. Can be small, medium, or large.                                | `"large" or "medium" or "small" or "tiny"`                           | `undefined` |
| `pill`        | `pill`        | Sets the button or link to render as a pill.                                                          | `boolean`                                                            | `false`     |
| `pjax`        | `pjax`        | Sets the button or link as an outlined button.                                                        | `boolean`                                                            | `false`     |
| `processable` | `processable` | Sets the button or link as processing when clicked.                                                   | `boolean`                                                            | `false`     |
| `size`        | `size`        | Sets the size of the button. Can be tiny, small, medium, or large.                                    | `"large" or "medium" or "small" or "tiny"`                           | `undefined` |
| `tag`         | `tag`         | Allows the button to render for different tags.                                                       | `"button" or "link" or "pjax" or "route-link" or "span" or "submit"` | `"link"`    |
