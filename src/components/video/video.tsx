...
export class Video {
  ...
  render () {
    return (
      <video preload={this.preload} width={this.width} height={this.height} autoplay={this.autoplay} muted={this.muted} playsinline={this.playsinline} poster="/global/video/engineering.png">
        <slot />
      </video>
    )
  }
